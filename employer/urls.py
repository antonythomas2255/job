...
urlpatterns = [
    ...
    path('users/accounts/change', views.ChangePassword.as_view(), name="password-change"),
    path('users/accounts/reset', views.PasswordResetView.as_view(), name="password-reset"),
